...
function PinyinChartPage() {
  ...
  const speakSyllable = (syllable, tone) => {
    ...
    const utterance = new SpeechSynthesisUtterance(toned)
    ...
    <div className="min-h-screen bg-background text-text-primary">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-card border border-border rounded-xl p-5 flex flex-col justify-start">
                ...
                {[1, 2, 3, 4].map((tone) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full p-4 bg-surface border border-border hover:border-primary hover:bg-primary/5 rounded-xl flex items-center justify-between transition-all hover:scale-102 active:scale-98"
                    >
                      ...
                      <SpeakerIcon className="w-5 h-5 text-text-secondary hover:text-primary" />
                    </button>
                  )
                })}
              </div>
