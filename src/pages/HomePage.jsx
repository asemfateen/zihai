  ...
  return (
    <div className="min-h-screen bg-transparent relative z-10">
      ...
      <div className="flex flex-col items-center justify-center px-4 pt-24 sm:pt-32 pb-20">
        <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold bg-gradient-to-r from-primary via-rose-500 to-orange-500 bg-clip-text text-transparent mb-4 tracking-tight drop-shadow-sm">
          字海
        </h1>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-xl">
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="px-4 sm:px-6 py-3 bg-gradient-to-r from-primary to-rose-600 text-white text-base sm:text-lg font-medium rounded-xl hover:shadow-lg hover:shadow-primary/30 transition-all hover:-translate-y-0.5 active:translate-y-0 border border-primary/20"
            >
              Search
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-transparent relative z-10 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:auto-rows-[140px]">
          
          {/* Welcome Hero - spans all 4 cols on desktop, 2 on mobile */}
          <div className="col-span-2 md:col-span-4 bg-gradient-to-br from-primary via-rose-600 to-orange-500 rounded-3xl p-6 md:p-8 flex flex-col justify-center text-white shadow-xl shadow-primary/20 relative overflow-hidden animate-fade-in md:h-auto min-h-[140px]">
          ...
          <div className="col-span-2 md:col-span-4 bg-card/80 backdrop-blur-xl border border-border/50 rounded-3xl shadow-sm overflow-hidden animate-fade-in [animation-delay:450ms] flex flex-col h-full min-h-[250px] mt-2">
