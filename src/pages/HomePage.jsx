      ...
      <div className="flex flex-col items-center justify-center px-4 pt-16 sm:pt-24 pb-20 max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-xl animate-fade-in">
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="px-4 sm:px-6 py-3 bg-cta text-text-primary text-base sm:text-lg font-bold btn-brutal cursor-pointer"
            >
              Search
            </button>
          </div>
        ...
        <div className="mt-8 animate-fade-in flex gap-4">
          <button
            ...
            className="px-6 py-3 bg-primary btn-brutal flex items-center gap-2 text-text-primary font-bold"
          >
    ...
    <div className="min-h-screen bg-transparent relative z-10 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:auto-rows-[140px]">
          ...
          <div className="col-span-2 md:col-span-5 bg-primary shadow-brutal p-6 md:p-8 flex flex-col justify-center text-text-primary relative overflow-hidden animate-fade-in md:h-auto min-h-[140px]">
          ...
          >
            ...
            <div className="relative z-10 mt-6 md:mt-4">
              ...
              <button className="w-full py-3 bg-cta text-text-primary font-bold btn-brutal">
                Start Reviewing
              </button>
            </div>
          </div>
          ...
          <button
            ...
            className="col-span-1 md:row-span-1 bg-card btn-brutal p-4 flex flex-col items-center justify-center gap-3 group animate-fade-in [animation-delay:150ms] min-h-[120px]"
          >
          ...
          <button
            ...
            className="col-span-1 md:row-span-1 bg-card btn-brutal p-4 flex flex-col items-center justify-center gap-3 group animate-fade-in [animation-delay:200ms] min-h-[120px]"
          >
          ...
          <button
            ...
            className="col-span-1 md:row-span-1 bg-card btn-brutal p-4 flex flex-col items-center justify-center gap-3 group animate-fade-in [animation-delay:250ms] min-h-[120px]"
          >
          ...
          <button
            onClick={() => navigate('/analyzer')}
            className="col-span-1 md:row-span-1 bg-card btn-brutal p-4 flex flex-col items-center justify-center gap-3 group animate-fade-in [animation-delay:350ms] min-h-[120px]"
          >
          ...
          <button
            ...
            className="col-span-1 md:row-span-1 bg-card btn-brutal p-4 flex flex-col items-center justify-center gap-3 group animate-fade-in [animation-delay:300ms] min-h-[120px]"
          >
          ...
          <div className="col-span-2 md:col-span-5 bg-card shadow-brutal overflow-hidden animate-fade-in [animation-delay:450ms] flex flex-col h-full min-h-[250px] mt-2">
            <div className="flex items-center gap-3 px-6 py-5 border-b-[3px] border-border bg-surface">
